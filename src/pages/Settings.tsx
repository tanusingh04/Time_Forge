...
import { Bell, Palette, Clock, Sun, Moon } from "lucide-react";
...
const SettingsPage = () => {
    ...
    const clearAllData = () => {
        localStorage.clear();
        toast({ title: "Logged out", description: "Your local data cache has been cleared." });
    ...
    return (<Layout>
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} className="bg-card rounded-xl p-6 border border-border space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="bg-card rounded-xl p-6 border border-border space-y-6">
          <h2 className="font-semibold flex items-center gap-2">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="bg-card rounded-xl p-6 border border-border space-y-6">
          <h2 className="font-semibold flex items-center gap-2">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.15 }} className="bg-card rounded-xl p-6 border border-destructive/20 space-y-4">
