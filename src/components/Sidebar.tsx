...
import { LayoutDashboard, ListTodo, Calendar, User, Settings, FileText, Bot, School, ClipboardList, Sun, Moon, } from "lucide-react";
      ...
      <nav className="flex-1 px-3 space-y-1">
        {navItems.map((item) => {
            ...
            return (<Link key={item.path} to={item.path}>
              <motion.div whileHover={{ x: 4 }} className={`flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium transition-colors ${isActive
